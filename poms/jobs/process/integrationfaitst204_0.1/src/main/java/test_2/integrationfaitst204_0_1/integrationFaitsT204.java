...
package test_2.integrationfaitst204_0_1;
...
/**
 * Job: integrationFaitsT204 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class integrationFaitsT204 implements TalendJob {
	...
	private final String jobName = "integrationFaitsT204";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					integrationFaitsT204.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(integrationFaitsT204.this, new Object[] {
	...
	public static class row4Struct implements
		...
		final static byte[] commonByteArrayLock_TEST_2_integrationFaitsT204 = new byte[0];
		static byte[] commonByteArray_TEST_2_integrationFaitsT204 = new byte[0];

		public Integer id_age_fk;

		public Integer getId_age_fk() {
			return this.id_age_fk;
		}

		public Integer id_sexe_fk;

		public Integer getId_sexe_fk() {
			return this.id_sexe_fk;
		}

		public Integer id_taille_entreprise_fk;

		public Integer getId_taille_entreprise_fk() {
			return this.id_taille_entreprise_fk;
		}

		public Integer id_categorie_socio_prof_fk;

		public Integer getId_categorie_socio_prof_fk() {
			return this.id_categorie_socio_prof_fk;
		}

		public Integer id_pays_fk;

		public Integer getId_pays_fk() {
			return this.id_pays_fk;
		}

		public Integer id_secteur_activite_fk;

		public Integer getId_secteur_activite_fk() {
			return this.id_secteur_activite_fk;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_2_integrationFaitsT204) {

				try {

					int length = 0;

					this.id_age_fk = readInteger(dis);

					this.id_sexe_fk = readInteger(dis);

					this.id_taille_entreprise_fk = readInteger(dis);

					this.id_categorie_socio_prof_fk = readInteger(dis);

					this.id_pays_fk = readInteger(dis);

					this.id_secteur_activite_fk = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.id_age_fk, dos);

				// Integer

				writeInteger(this.id_sexe_fk, dos);

				// Integer

				writeInteger(this.id_taille_entreprise_fk, dos);

				// Integer

				writeInteger(this.id_categorie_socio_prof_fk, dos);

				// Integer

				writeInteger(this.id_pays_fk, dos);

				// Integer

				writeInteger(this.id_secteur_activite_fk, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("id_age_fk=" + String.valueOf(id_age_fk));
			sb.append(",id_sexe_fk=" + String.valueOf(id_sexe_fk));
			sb.append(",id_taille_entreprise_fk="
					+ String.valueOf(id_taille_entreprise_fk));
			sb.append(",id_categorie_socio_prof_fk="
					+ String.valueOf(id_categorie_socio_prof_fk));
			sb.append(",id_pays_fk=" + String.valueOf(id_pays_fk));
			sb.append(",id_secteur_activite_fk="
					+ String.valueOf(id_secteur_activite_fk));
	...
	public static class integration_T204Struct implements
			routines.system.IPersistableRow<integration_T204Struct> {
		final static byte[] commonByteArrayLock_TEST_2_integrationFaitsT204 = new byte[0];
		static byte[] commonByteArray_TEST_2_integrationFaitsT204 = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(integration_T204Struct other) {
	...
	public static class row1Struct implements
		...
		public String Tranche_d_effectif_de_l__tablissement__en_12_modalit_s_;

		public String getTranche_d_effectif_de_l__tablissement__en_12_modalit_s_() {
			return this.Tranche_d_effectif_de_l__tablissement__en_12_modalit_s_;
		}

		public Integer Salaire_brut_en_equivalent_temps_plein____;

		public Integer getSalaire_brut_en_equivalent_temps_plein____() {
			return this.Salaire_brut_en_equivalent_temps_plein____;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_2_integrationFaitsT204.length) {
					if (length < 1024
							&& commonByteArray_TEST_2_integrationFaitsT204.length == 0) {
						commonByteArray_TEST_2_integrationFaitsT204 = new byte[1024];
					} else {
						commonByteArray_TEST_2_integrationFaitsT204 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_2_integrationFaitsT204, 0,
						length);
				strReturn = new String(
						commonByteArray_TEST_2_integrationFaitsT204, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_2_integrationFaitsT204) {
				...
				try {
					...
					this.Tranche_d_effectif_de_l__tablissement__en_12_modalit_s_ = readString(dis);

					this.Salaire_brut_en_equivalent_temps_plein____ = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(
						this.Tranche_d_effectif_de_l__tablissement__en_12_modalit_s_,
						dos);

				// Integer

				writeInteger(this.Salaire_brut_en_equivalent_temps_plein____,
						dos);
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("Tranche_d_effectif_de_l__tablissement__en_12_modalit_s_="
					+ Tranche_d_effectif_de_l__tablissement__en_12_modalit_s_);
			sb.append(",Salaire_brut_en_equivalent_temps_plein____="
					+ String.valueOf(Salaire_brut_en_equivalent_temps_plein____));
	...
	public void tFileInputExcel_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				integration_T204Struct integration_T204 = new integration_T204Struct();
				integration_T204Struct row4 = integration_T204;
				...
				String insert_tDBOutput_1 = "INSERT INTO ["
						...
						+ "] ([id_age_fk],[id_sexe_fk],[id_taille_entreprise_fk],[id_categorie_socio_prof_fk],[id_pays_fk],[id_secteur_activite_fk],[salaire]) VALUES (?,?,?,?,?,?,?)";
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("integration_T204"
								+ iterateId, 0, 0);
				...
				integration_T204Struct integration_T204_tmp = new integration_T204Struct();
				// ###############################
				...
				Object source_tFileInputExcel_1 = "C:/Users/hakan/OneDrive/M2/Semestre 2/PROJET ENT/2 - Réalisation/SOURCES - Transformation/Transformation T204.xls";
				...
				try {
					...
					sheetList_tFileInputExcel_1
							.addAll(regexUtil_tFileInputExcel_1.getSheets(
									workbook_tFileInputExcel_1, "C - T", false));
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1]
									...
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1
											+ 1;
									curColName_tFileInputExcel_1 = "Tranche_d_effectif_de_l__tablissement__en_12_modalit_s_";
									row1.Tranche_d_effectif_de_l__tablissement__en_12_modalit_s_ = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1]
											.trim();
								} else {
									row1.Tranche_d_effectif_de_l__tablissement__en_12_modalit_s_ = null;
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1]
									...
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1
											+ 1;
									curColName_tFileInputExcel_1 = "Salaire_brut_en_equivalent_temps_plein____";
									row1.Salaire_brut_en_equivalent_temps_plein____ = ParserUtils
											.parseTo_Integer(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1]
													.trim());
								} else {
									row1.Salaire_brut_en_equivalent_temps_plein____ = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (emptyColumnCount_tFileInputExcel_1 >= 3) {
									break; // if meet the empty row, there will
											// break the iterate.
								}
							...
							if (row1 != null) {
								...
								if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
									...
									row2HashKey.libelle_taille_entreprise = row1.Tranche_d_effectif_de_l__tablissement__en_12_modalit_s_;
								...
								if (tHash_Lookup_row2 != null
									...
									// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.libelle_taille_entreprise = '"
									// + row2HashKey.libelle_taille_entreprise +
									// "'");
								} // G 071
								...
								if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
									...
									row3HashKey.libelle_sexe = row1.Column2;
								...
								if (tHash_Lookup_row3 != null
									...
									// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.libelle_sexe = '"
									// + row3HashKey.libelle_sexe + "'");
								} // G 071
								...
								{ // start of Var scope
									...
									integration_T204 = null;

									// # Output table : 'integration_T204'
									integration_T204_tmp.id_age_fk = null;
									integration_T204_tmp.id_sexe_fk = row3.id_sexe_pk;
									integration_T204_tmp.id_taille_entreprise_fk = row2.id_taille_entreprise_pk;
									integration_T204_tmp.id_categorie_socio_prof_fk = null;
									integration_T204_tmp.id_pays_fk = null;
									integration_T204_tmp.id_secteur_activite_fk = null;
									integration_T204_tmp.salaire = row1.Salaire_brut_en_equivalent_temps_plein____;
									integration_T204 = integration_T204_tmp;
									// ###############################
								 ...
								 */
								// Start of branch "integration_T204"
								if (integration_T204 != null) {
									...
									if (integration_T204.id_age_fk != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(integration_T204.id_age_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (integration_T204.id_sexe_fk != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(integration_T204.id_sexe_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (integration_T204.id_taille_entreprise_fk != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(integration_T204.id_taille_entreprise_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (integration_T204.id_categorie_socio_prof_fk != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(integration_T204.id_categorie_socio_prof_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (integration_T204.id_pays_fk != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(integration_T204.id_pays_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (integration_T204.id_secteur_activite_fk != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(integration_T204.id_secteur_activite_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (integration_T204.salaire != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(integration_T204.salaire));
									...
									if (row4.id_taille_entreprise_fk == null) {
										pstmt_tDBOutput_1.setNull(3,
												java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(3,
												row4.id_taille_entreprise_fk);
									}

									if (row4.id_categorie_socio_prof_fk == null) {
										pstmt_tDBOutput_1.setNull(4,
												java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1
												.setInt(4,
														row4.id_categorie_socio_prof_fk);
									}

									if (row4.id_pays_fk == null) {
									...
									if (row4.id_secteur_activite_fk == null) {
										pstmt_tDBOutput_1.setNull(6,
												java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(6,
												row4.id_secteur_activite_fk);
									}
								...
								} // End of branch "integration_T204"
	...
	public static class row2Struct implements
		...
		public int id_taille_entreprise_pk;

		public int getId_taille_entreprise_pk() {
			return this.id_taille_entreprise_pk;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.libelle_taille_entreprise == null) ? 0
								: this.libelle_taille_entreprise.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.libelle_taille_entreprise == null) {
				if (other.libelle_taille_entreprise != null)
					return false;

			} else if (!this.libelle_taille_entreprise
					.equals(other.libelle_taille_entreprise))
		...
		public void copyDataTo(row2Struct other) {
			...
			other.id_taille_entreprise_pk = this.id_taille_entreprise_pk;
			other.libelle_taille_entreprise = this.libelle_taille_entreprise;
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.id_taille_entreprise_pk = dis.readInt();
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				dos.writeInt(this.id_taille_entreprise_pk);
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("id_taille_entreprise_pk="
					+ String.valueOf(id_taille_entreprise_pk));
		...
		public int compareTo(row2Struct other) {
			...
			returnValue = checkNullsAndCompare(this.libelle_taille_entreprise,
					other.libelle_taille_entreprise);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbname_tDBInput_1 = "PROJET_ENT";
				...
				String dbquery_tDBInput_1 = "SELECT TAILLE_ENTREPRISE_DIM.id_taille_entreprise_pk,\n		TAILLE_ENTREPRISE_DIM.libelle_taille_entreprise\nFROM	TAILLE_ENT"
						+ "REPRISE_DIM";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							row2.id_taille_entreprise_pk = 0;
						} else {

							if (rs_tDBInput_1.getObject(1) != null) {
								row2.id_taille_entreprise_pk = rs_tDBInput_1
										.getInt(1);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							row2.libelle_taille_entreprise = null;
						} else {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1
									...
									row2.libelle_taille_entreprise = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row2.libelle_taille_entreprise = tmpContent_tDBInput_1;
								}
							} else {
								row2.libelle_taille_entreprise = null;
							}
						...
						row2_HashRow.id_taille_entreprise_pk = row2.id_taille_entreprise_pk;

						row2_HashRow.libelle_taille_entreprise = row2.libelle_taille_entreprise;
	...
	public static class row3Struct implements
		...
		public int id_sexe_pk;

		public int getId_sexe_pk() {
			return this.id_sexe_pk;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.libelle_sexe == null) ? 0 : this.libelle_sexe
								.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.libelle_sexe == null) {
				if (other.libelle_sexe != null)
					return false;

			} else if (!this.libelle_sexe.equals(other.libelle_sexe))
		...
		public void copyDataTo(row3Struct other) {
			...
			other.id_sexe_pk = this.id_sexe_pk;
			other.libelle_sexe = this.libelle_sexe;
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("id_sexe_pk=" + String.valueOf(id_sexe_pk));
		...
		public int compareTo(row3Struct other) {
			...
			returnValue = checkNullsAndCompare(this.libelle_sexe,
					other.libelle_sexe);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String port_tDBInput_2 = "52890";
				String dbname_tDBInput_2 = "PROJET_ENT";
				String url_tDBInput_2 = "jdbc:jtds:sqlserver://"
						+ "desktop-4c70u1q";
				if (!"".equals(port_tDBInput_2)) {
					url_tDBInput_2 += ":" + "52890";
				}
				if (!"".equals(dbname_tDBInput_2)) {
					url_tDBInput_2 += "//" + "PROJET_ENT";
				}
				...
				String dbquery_tDBInput_2 = "SELECT SEXE_DIM.id_sexe_pk,\n		SEXE_DIM.libelle_sexe\nFROM	SEXE_DIM";
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							if (rs_tDBInput_2.getObject(1) != null) {
								row3.id_sexe_pk = rs_tDBInput_2.getInt(1);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
										.contains(rsmd_tDBInput_2
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row3.libelle_sexe = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row3.libelle_sexe = tmpContent_tDBInput_2;
								}
							} else {
								row3.libelle_sexe = null;
							}
						...
						row3_HashRow.id_sexe_pk = row3.id_sexe_pk;

						row3_HashRow.libelle_sexe = row3.libelle_sexe;
	...
	public static void main(String[] args) {
		final integrationFaitsT204 integrationFaitsT204Class = new integrationFaitsT204();

		int exitCode = integrationFaitsT204Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = integrationFaitsT204.class
					.getClassLoader().getResourceAsStream(
							"test_2/integrationfaitst204_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = integrationFaitsT204.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : integrationFaitsT204");
		}
...
/************************************************************************************************
 * 113182 characters generated by Talend Open Studio for Data Integration on the
 * 28 mai 2019 01:16:35 CEST
 ************************************************************************************************/
