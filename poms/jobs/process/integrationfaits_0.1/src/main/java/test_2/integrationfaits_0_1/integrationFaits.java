...
package test_2.integrationfaits_0_1;
...
/**
 * Job: integrationFaits Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class integrationFaits implements TalendJob {
	...
	private final String jobName = "integrationFaits";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					integrationFaits.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(integrationFaits.this, new Object[] { e,
	...
	public static class row4Struct implements
		...
		final static byte[] commonByteArrayLock_TEST_2_integrationFaits = new byte[0];
		static byte[] commonByteArray_TEST_2_integrationFaits = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_2_integrationFaits.length) {
					if (length < 1024
							&& commonByteArray_TEST_2_integrationFaits.length == 0) {
						commonByteArray_TEST_2_integrationFaits = new byte[1024];
					} else {
						commonByteArray_TEST_2_integrationFaits = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_2_integrationFaits, 0,
						length);
				strReturn = new String(commonByteArray_TEST_2_integrationFaits,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_2_integrationFaits) {
	...
	public static class testIntegStruct implements
			routines.system.IPersistableRow<testIntegStruct> {
		final static byte[] commonByteArrayLock_TEST_2_integrationFaits = new byte[0];
		static byte[] commonByteArray_TEST_2_integrationFaits = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(testIntegStruct other) {
	...
	public void tFileInputExcel_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				testIntegStruct testInteg = new testIntegStruct();
				testIntegStruct row4 = testInteg;
				...
				String insert_tDBOutput_1 = "INSERT INTO ["
						...
						+ "] ([id_age_fk],[id_sexe_fk],[id_taille_entreprise_fk],[id_categorie_socio_prof_fk],[id_secteur_activite_fk],[salaire]) VALUES (?,?,?,?,?,?)";
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("testInteg" + iterateId,
								0, 0);
				...
				testIntegStruct testInteg_tmp = new testIntegStruct();
				// ###############################
				...
				Object source_tFileInputExcel_1 = "C:/Users/hakan/OneDrive/M2/Semestre 2/PROJET ENT/2 - Réalisation/Nettoyage/Nettoyage T201.xls";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							if (row1 != null) {
								...
								if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
									...
									row3HashKey.libelle_socio_prof = row1.categorie;
								...
								{ // start of Var scope
									...
									// # Output table : 'testInteg'
									testInteg_tmp.id_age_fk = row2.id_age_pk;
									testInteg_tmp.id_sexe_fk = null;
									testInteg_tmp.id_taille_entreprise_fk = null;
									testInteg_tmp.id_categorie_socio_prof_fk = row3.id_categorie_socio_prof_pk;
									testInteg_tmp.id_secteur_activite_fk = null;
									testInteg_tmp.salaire = row1.valeur;
									testInteg = testInteg_tmp;
									// ###############################
								...
								if (testInteg != null) {
									...
									if (testInteg.id_age_fk != null) { //

										strBuffer_tLogRow_1.append(String
												.valueOf(testInteg.id_age_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (testInteg.id_sexe_fk != null) { //

										strBuffer_tLogRow_1.append(String
												.valueOf(testInteg.id_sexe_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (testInteg.id_taille_entreprise_fk != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(testInteg.id_taille_entreprise_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (testInteg.id_categorie_socio_prof_fk != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(testInteg.id_categorie_socio_prof_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (testInteg.id_secteur_activite_fk != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(testInteg.id_secteur_activite_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (testInteg.salaire != null) { //

										strBuffer_tLogRow_1.append(String
												.valueOf(testInteg.salaire));
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_1 = "SELECT AGE_DIM.id_age_pk,\n		AGE_DIM.libelle_age\nFROM	AGE_DIM";
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							if (rs_tDBInput_1.getObject(1) != null) {
								row2.id_age_pk = rs_tDBInput_1.getInt(1);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1
									...
									row2.libelle_age = tmpContent_tDBInput_1;
								}
							} else {
								row2.libelle_age = null;
							}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_2 = "SELECT CATEGORIE_SOCIO_PROF_DIM.id_categorie_socio_prof_pk,\n		CATEGORIE_SOCIO_PROF_DIM.libelle_socio_prof\nFROM	CATEGORI"
						+ "E_SOCIO_PROF_DIM";
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							if (rs_tDBInput_2.getObject(1) != null) {
								row3.id_categorie_socio_prof_pk = rs_tDBInput_2
										.getInt(1);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
									...
									row3.libelle_socio_prof = tmpContent_tDBInput_2;
								}
							} else {
								row3.libelle_socio_prof = null;
							}
	...
	public static void main(String[] args) {
		final integrationFaits integrationFaitsClass = new integrationFaits();

		int exitCode = integrationFaitsClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = integrationFaits.class
					.getClassLoader().getResourceAsStream(
							"test_2/integrationfaits_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = integrationFaits.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : integrationFaits");
		}
...
/************************************************************************************************
 * 113356 characters generated by Talend Open Studio for Data Integration on the
 * 27 mai 2019 14:14:20 CEST
 ************************************************************************************************/
