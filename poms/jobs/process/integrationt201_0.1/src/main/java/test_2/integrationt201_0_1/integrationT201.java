...
package test_2.integrationt201_0_1;
...
/**
 * Job: integrationT201 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class integrationT201 implements TalendJob {
	...
	private final String jobName = "integrationT201";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					integrationT201.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(integrationT201.this, new Object[] { e,
	...
	public static class row5Struct implements
		...
		final static byte[] commonByteArrayLock_TEST_2_integrationT201 = new byte[0];
		static byte[] commonByteArray_TEST_2_integrationT201 = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_2_integrationT201) {
	...
	public static class yyttyyyyyyStruct implements
			routines.system.IPersistableRow<yyttyyyyyyStruct> {
		final static byte[] commonByteArrayLock_TEST_2_integrationT201 = new byte[0];
		static byte[] commonByteArray_TEST_2_integrationT201 = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(yyttyyyyyyStruct other) {
	...
	public static class row1Struct implements
		...
		public String Categorie_Socioprofessionnelle;

		public String getCategorie_Socioprofessionnelle() {
			return this.Categorie_Socioprofessionnelle;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_2_integrationT201.length) {
					if (length < 1024
							&& commonByteArray_TEST_2_integrationT201.length == 0) {
						commonByteArray_TEST_2_integrationT201 = new byte[1024];
					} else {
						commonByteArray_TEST_2_integrationT201 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_2_integrationT201, 0, length);
				strReturn = new String(commonByteArray_TEST_2_integrationT201,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_2_integrationT201) {
				...
				try {
					...
					this.Categorie_Socioprofessionnelle = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.Categorie_Socioprofessionnelle, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("Age=" + Age);
			sb.append(",Categorie_Socioprofessionnelle="
	...
	public void tFileInputExcel_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				yyttyyyyyyStruct yyttyyyyyy = new yyttyyyyyyStruct();
				yyttyyyyyyStruct row5 = yyttyyyyyy;
				...
				yyttyyyyyyStruct yyttyyyyyy_tmp = new yyttyyyyyyStruct();
				// ###############################
				...
				Object source_tFileInputExcel_1 = "C:/Users/hakan/OneDrive/M2/Semestre 2/PROJET ENT/2 - Réalisation/SOURCES - Transformation/Transformation T201.xls";
				...
				try {
					...
					sheetList_tFileInputExcel_1
							.addAll(regexUtil_tFileInputExcel_1.getSheets(
									workbook_tFileInputExcel_1, "akjzkjzkjak",
									false));
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1]
									...
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1
											+ 1;
									curColName_tFileInputExcel_1 = "Categorie_Socioprofessionnelle";
									row1.Categorie_Socioprofessionnelle = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1]
											.trim();
								} else {
									row1.Categorie_Socioprofessionnelle = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
							...
							if (row1 != null) {
								...
								if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
									...
									row2HashKey.libelle_age = row1.Age;
								...
								if (tHash_Lookup_row2 != null
									...
									// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.libelle_age = '"
									// + row2HashKey.libelle_age + "'");
								} // G 071
								...
								if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
									...
									row3HashKey.libelle_socio_prof = row1.Categorie_Socioprofessionnelle;
								...
								if (tHash_Lookup_row3 != null
									...
									// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.libelle_socio_prof = '"
									// + row3HashKey.libelle_socio_prof + "'");
								} // G 071
								...
								{ // start of Var scope
									...
									// # Output table : 'yyttyyyyyy'
									yyttyyyyyy_tmp.id_age_fk = row2.id_age_pk;
									yyttyyyyyy_tmp.id_sexe_fk = row4.id_sexe_pk;
									yyttyyyyyy_tmp.id_taille_entreprise_fk = null;
									yyttyyyyyy_tmp.id_categorie_socio_prof_fk = row3.id_categorie_socio_prof_pk;
									yyttyyyyyy_tmp.id_pays_fk = null;
									yyttyyyyyy_tmp.id_secteur_activite_fk = null;
									yyttyyyyyy_tmp.salaire = row1.Valeur;
									yyttyyyyyy = yyttyyyyyy_tmp;
									// ###############################
								...
								if (yyttyyyyyy != null) {
									...
									if (yyttyyyyyy.id_age_fk != null) { //

										strBuffer_tLogRow_1.append(String
												.valueOf(yyttyyyyyy.id_age_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (yyttyyyyyy.id_sexe_fk != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(yyttyyyyyy.id_sexe_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (yyttyyyyyy.id_taille_entreprise_fk != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(yyttyyyyyy.id_taille_entreprise_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (yyttyyyyyy.id_categorie_socio_prof_fk != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(yyttyyyyyy.id_categorie_socio_prof_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (yyttyyyyyy.id_pays_fk != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(yyttyyyyyy.id_pays_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (yyttyyyyyy.id_secteur_activite_fk != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(yyttyyyyyy.id_secteur_activite_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (yyttyyyyyy.salaire != null) { //

										strBuffer_tLogRow_1.append(String
												.valueOf(yyttyyyyyy.salaire));
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// inputs:(row4) outputs:()
				// linked node: tMap_1 - inputs:(row1,row4,row2,row3)
				// outputs:(yyttyyyyyy)
				...
				String dbquery_tDBInput_1 = "SELECT SEXE_DIM.id_sexe_pk,\n		SEXE_DIM.libelle_sexe\nFROM	SEXE_DIM";
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							if (rs_tDBInput_1.getObject(1) != null) {
								row4.id_sexe_pk = rs_tDBInput_1.getInt(1);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1
									...
									row4.libelle_sexe = tmpContent_tDBInput_1;
								}
							} else {
								row4.libelle_sexe = null;
							}
	...
	public static class row2Struct implements
		...
		public int id_age_pk;

		public int getId_age_pk() {
			return this.id_age_pk;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.libelle_age == null) ? 0 : this.libelle_age
								.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.libelle_age == null) {
				if (other.libelle_age != null)
					return false;

			} else if (!this.libelle_age.equals(other.libelle_age))
		...
		public void copyDataTo(row2Struct other) {
			...
			other.id_age_pk = this.id_age_pk;
			other.code_age = this.code_age;
			other.libelle_age = this.libelle_age;
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.id_age_pk = dis.readInt();

				this.code_age = readString(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				dos.writeInt(this.id_age_pk);

				writeString(this.code_age, dos, oos);
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("id_age_pk=" + String.valueOf(id_age_pk));
		...
		public int compareTo(row2Struct other) {
			...
			returnValue = checkNullsAndCompare(this.libelle_age,
					other.libelle_age);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_2 = "SELECT AGE_DIM.id_age_pk,\n		AGE_DIM.code_age,\n		AGE_DIM.libelle_age\nFROM	AGE_DIM";
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							if (rs_tDBInput_2.getObject(1) != null) {
								row2.id_age_pk = rs_tDBInput_2.getInt(1);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
										.contains(rsmd_tDBInput_2
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row2.code_age = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row2.code_age = tmpContent_tDBInput_2;
								}
							} else {
								row2.code_age = null;
							}
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
										.contains(rsmd_tDBInput_2
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row2.libelle_age = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row2.libelle_age = tmpContent_tDBInput_2;
								}
							} else {
								row2.libelle_age = null;
							}
						...
						row2_HashRow.id_age_pk = row2.id_age_pk;

						row2_HashRow.code_age = row2.code_age;

						row2_HashRow.libelle_age = row2.libelle_age;
	...
	public static class row3Struct implements
		...
		public int id_categorie_socio_prof_pk;

		public int getId_categorie_socio_prof_pk() {
			return this.id_categorie_socio_prof_pk;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.libelle_socio_prof == null) ? 0
								: this.libelle_socio_prof.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.libelle_socio_prof == null) {
				if (other.libelle_socio_prof != null)
					return false;

			} else if (!this.libelle_socio_prof
					.equals(other.libelle_socio_prof))
		...
		public void copyDataTo(row3Struct other) {
			...
			other.id_categorie_socio_prof_pk = this.id_categorie_socio_prof_pk;
			other.libelle_socio_prof = this.libelle_socio_prof;
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.id_categorie_socio_prof_pk = dis.readInt();
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				dos.writeInt(this.id_categorie_socio_prof_pk);
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("id_categorie_socio_prof_pk="
					+ String.valueOf(id_categorie_socio_prof_pk));
		...
		public int compareTo(row3Struct other) {
			...
			returnValue = checkNullsAndCompare(this.libelle_socio_prof,
					other.libelle_socio_prof);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_3 = "SELECT CATEGORIE_SOCIO_PROF_DIM.id_categorie_socio_prof_pk,\n		CATEGORIE_SOCIO_PROF_DIM.libelle_socio_prof\nFROM	CATEGORI"
						+ "E_SOCIO_PROF_DIM";
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 1) {
							row3.id_categorie_socio_prof_pk = 0;
						} else {

							if (rs_tDBInput_3.getObject(1) != null) {
								row3.id_categorie_socio_prof_pk = rs_tDBInput_3
										.getInt(1);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							...
							if (tmpContent_tDBInput_3 != null) {
								if (talendToDBList_tDBInput_3
										.contains(rsmd_tDBInput_3
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row3.libelle_socio_prof = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_3);
								} else {
									row3.libelle_socio_prof = tmpContent_tDBInput_3;
								}
							} else {
								row3.libelle_socio_prof = null;
							}
						...
						row3_HashRow.id_categorie_socio_prof_pk = row3.id_categorie_socio_prof_pk;

						row3_HashRow.libelle_socio_prof = row3.libelle_socio_prof;
	...
	public static void main(String[] args) {
		final integrationT201 integrationT201Class = new integrationT201();

		int exitCode = integrationT201Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = integrationT201.class
					.getClassLoader().getResourceAsStream(
							"test_2/integrationt201_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = integrationT201.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : integrationT201");
		}
...
/************************************************************************************************
 * 132485 characters generated by Talend Open Studio for Data Integration on the
 * 28 mai 2019 02:07:08 CEST
 ************************************************************************************************/
