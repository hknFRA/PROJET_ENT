...
package test_2.conversionexcelcsv_0_1;
...
/**
 * Job: conversionExcelCSV Purpose: conversionExcelCSV<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class conversionExcelCSV implements TalendJob {
	...
	private final String jobName = "conversionExcelCSV";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					conversionExcelCSV.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(conversionExcelCSV.this, new Object[] { e,
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_TEST_2_conversionExcelCSV = new byte[0];
		static byte[] commonByteArray_TEST_2_conversionExcelCSV = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_2_conversionExcelCSV.length) {
					if (length < 1024
							&& commonByteArray_TEST_2_conversionExcelCSV.length == 0) {
						commonByteArray_TEST_2_conversionExcelCSV = new byte[1024];
					} else {
						commonByteArray_TEST_2_conversionExcelCSV = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_2_conversionExcelCSV, 0,
						length);
				strReturn = new String(
						commonByteArray_TEST_2_conversionExcelCSV, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_2_conversionExcelCSV) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Users/hakan/OneDrive/M2/Semestre 2/PROJET ENT/2 - Réalisation/DIM - Conversion CSV/out.csv"))
				...
				if (filetFileOutputDelimited_1.length() == 0) {
					outtFileOutputDelimited_1.write("code_sexe");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("libelle_sexe");
					outtFileOutputDelimited_1
				...
				Object source_tFileInputExcel_1 = "C:/Users/hakan/OneDrive/M2/Semestre 2/PROJET ENT/2 - Réalisation/Transformation/SEXE_DIM.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1]
									...
									row1.libelle_sexe = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1]
											.trim();
								} else {
									row1.libelle_sexe = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
							...
							if (row1 != null) {
								...
								if (row1.code_sexe != null) {
									sb_tFileOutputDelimited_1
											.append(row1.code_sexe);
								}
								sb_tFileOutputDelimited_1
										.append(OUT_DELIM_tFileOutputDelimited_1);
								if (row1.libelle_sexe != null) {
									sb_tFileOutputDelimited_1
											.append(row1.libelle_sexe);
								}
								sb_tFileOutputDelimited_1
	...
	public static void main(String[] args) {
		final conversionExcelCSV conversionExcelCSVClass = new conversionExcelCSV();

		int exitCode = conversionExcelCSVClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = conversionExcelCSV.class
					.getClassLoader().getResourceAsStream(
							"test_2/conversionexcelcsv_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = conversionExcelCSV.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : conversionExcelCSV");
		}
...
/************************************************************************************************
 * 48980 characters generated by Talend Open Studio for Data Integration on the
 * 25 mai 2019 21:00:18 CEST
 ************************************************************************************************/
