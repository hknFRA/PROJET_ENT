...
package test_2.integrationt403_0_1;
...
/**
 * Job: integrationT403 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class integrationT403 implements TalendJob {
	...
	private final String jobName = "integrationT403";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					integrationT403.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(integrationT403.this, new Object[] { e,
	...
	public static class row5Struct implements
		...
		final static byte[] commonByteArrayLock_TEST_2_integrationT403 = new byte[0];
		static byte[] commonByteArray_TEST_2_integrationT403 = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_2_integrationT403) {
	...
	public static class ghghghghStruct implements
			routines.system.IPersistableRow<ghghghghStruct> {
		final static byte[] commonByteArrayLock_TEST_2_integrationT403 = new byte[0];
		static byte[] commonByteArray_TEST_2_integrationT403 = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(ghghghghStruct other) {
	...
	public static class row1Struct implements
		...
		public String Tranche_d_effectif_de_l_etablissement__en_4_modalites_;

		public String getTranche_d_effectif_de_l_etablissement__en_4_modalites_() {
			return this.Tranche_d_effectif_de_l_etablissement__en_4_modalites_;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_2_integrationT403.length) {
					if (length < 1024
							&& commonByteArray_TEST_2_integrationT403.length == 0) {
						commonByteArray_TEST_2_integrationT403 = new byte[1024];
					} else {
						commonByteArray_TEST_2_integrationT403 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_2_integrationT403, 0, length);
				strReturn = new String(commonByteArray_TEST_2_integrationT403,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_2_integrationT403) {
				...
				try {
					...
					this.Tranche_d_effectif_de_l_etablissement__en_4_modalites_ = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(
						this.Tranche_d_effectif_de_l_etablissement__en_4_modalites_,
						dos);
		...
		public String toString() {
			...
			sb.append(",Tranche_d_effectif_de_l_etablissement__en_4_modalites_="
					+ Tranche_d_effectif_de_l_etablissement__en_4_modalites_);
	...
	public void tFileInputExcel_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ghghghghStruct ghghghgh = new ghghghghStruct();
				ghghghghStruct row5 = ghghghgh;
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("ghghghgh" + iterateId,
								0, 0);
				...
				ghghghghStruct ghghghgh_tmp = new ghghghghStruct();
				// ###############################
				...
				Object source_tFileInputExcel_1 = "C:/Users/hakan/OneDrive/M2/Semestre 2/PROJET ENT/2 - Réalisation/SOURCES - Transformation/Transformation T403 BIS CAR ENREGISTREMENT IMPOSSIBLE.xls";
				...
				try {
					...
					sheetList_tFileInputExcel_1
							.addAll(regexUtil_tFileInputExcel_1.getSheets(
									workbook_tFileInputExcel_1, "ajahjhzhzja",
									false));
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1]
									...
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1
											+ 1;
									curColName_tFileInputExcel_1 = "Tranche_d_effectif_de_l_etablissement__en_4_modalites_";
									row1.Tranche_d_effectif_de_l_etablissement__en_4_modalites_ = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1]
											.trim();
								} else {
									row1.Tranche_d_effectif_de_l_etablissement__en_4_modalites_ = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
							...
							if (row1 != null) {
								...
								if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
									...
									row2HashKey.libelle_pays = row1.region;
								...
								if (tHash_Lookup_row2 != null
									...
									// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.libelle_pays = '"
									// + row2HashKey.libelle_pays + "'");
								} // G 071
								...
								if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
									...
									row3HashKey.libelle_taille_entreprise = row1.Tranche_d_effectif_de_l_etablissement__en_4_modalites_;
								...
								if (tHash_Lookup_row3 != null
									...
									// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.libelle_taille_entreprise = '"
									// + row3HashKey.libelle_taille_entreprise +
									// "'");
								} // G 071
								...
								if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
									...
									row4HashKey.libelle_sexe = row1.Sexe;
								...
								if (tHash_Lookup_row4 != null
									...
									// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row4' and it contains more one result from keys :  row4.libelle_sexe = '"
									// + row4HashKey.libelle_sexe + "'");
								} // G 071
								...
								{ // start of Var scope
									...
									// # Output table : 'ghghghgh'
									ghghghgh_tmp.id_age_fk = null;
									ghghghgh_tmp.id_sexe_fk = row4.id_sexe_pk;
									ghghghgh_tmp.id_taille_entreprise_fk = row3.id_taille_entreprise_pk;
									ghghghgh_tmp.id_categorie_socio_prof_fk = null;
									ghghghgh_tmp.id_pays_fk = row2.id_pays_pk;
									ghghghgh_tmp.id_secteur_activite_fk = null;
									ghghghgh_tmp.salaire = row1.Valeur;
									ghghghgh = ghghghgh_tmp;
									// ###############################
								...
								if (ghghghgh != null) {
									...
									if (ghghghgh.id_age_fk != null) { //

										strBuffer_tLogRow_1.append(String
												.valueOf(ghghghgh.id_age_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (ghghghgh.id_sexe_fk != null) { //

										strBuffer_tLogRow_1.append(String
												.valueOf(ghghghgh.id_sexe_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (ghghghgh.id_taille_entreprise_fk != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(ghghghgh.id_taille_entreprise_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (ghghghgh.id_categorie_socio_prof_fk != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(ghghghgh.id_categorie_socio_prof_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (ghghghgh.id_pays_fk != null) { //

										strBuffer_tLogRow_1.append(String
												.valueOf(ghghghgh.id_pays_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (ghghghgh.id_secteur_activite_fk != null) { //

										strBuffer_tLogRow_1
												.append(String
														.valueOf(ghghghgh.id_secteur_activite_fk));

									} //

									strBuffer_tLogRow_1.append("|");

									if (ghghghgh.salaire != null) { //

										strBuffer_tLogRow_1.append(String
												.valueOf(ghghghgh.salaire));
									...
									if (row5.id_taille_entreprise_fk == null) {
										pstmt_tDBOutput_1.setNull(3,
												java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(3,
												row5.id_taille_entreprise_fk);
									}

									if (row5.id_categorie_socio_prof_fk == null) {
										pstmt_tDBOutput_1.setNull(4,
												java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1
												.setInt(4,
														row5.id_categorie_socio_prof_fk);
									}

									if (row5.id_pays_fk == null) {
									...
									if (row5.id_secteur_activite_fk == null) {
										pstmt_tDBOutput_1.setNull(6,
												java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(6,
												row5.id_secteur_activite_fk);
									}
	...
	public static class row2Struct implements
		...
		public int id_pays_pk;

		public int getId_pays_pk() {
			return this.id_pays_pk;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.libelle_pays == null) ? 0 : this.libelle_pays
								.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.libelle_pays == null) {
				if (other.libelle_pays != null)
					return false;

			} else if (!this.libelle_pays.equals(other.libelle_pays))
		...
		public void copyDataTo(row2Struct other) {
			...
			other.id_pays_pk = this.id_pays_pk;
			other.libelle_pays = this.libelle_pays;
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("id_pays_pk=" + String.valueOf(id_pays_pk));
		...
		public int compareTo(row2Struct other) {
			...
			returnValue = checkNullsAndCompare(this.libelle_pays,
					other.libelle_pays);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// inputs:(row2) outputs:()
				// linked node: tMap_1 - inputs:(row1,row2,row4,row3)
				// outputs:(ghghghgh)
				...
				String dbquery_tDBInput_1 = "SELECT PAYS_DIM.id_pays_pk,\n		PAYS_DIM.libelle_pays\nFROM	PAYS_DIM";
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							if (rs_tDBInput_1.getObject(1) != null) {
								row2.id_pays_pk = rs_tDBInput_1.getInt(1);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1
									...
									row2.libelle_pays = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row2.libelle_pays = tmpContent_tDBInput_1;
								}
							} else {
								row2.libelle_pays = null;
							}
						...
						row2_HashRow.id_pays_pk = row2.id_pays_pk;

						row2_HashRow.libelle_pays = row2.libelle_pays;
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							if (rs_tDBInput_2.getObject(1) != null) {
								row4.id_sexe_pk = rs_tDBInput_2.getInt(1);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
										.contains(rsmd_tDBInput_2
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row4.libelle_sexe = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row4.libelle_sexe = tmpContent_tDBInput_2;
								}
							} else {
								row4.libelle_sexe = null;
							}
						...
						row4_HashRow.id_sexe_pk = row4.id_sexe_pk;

						row4_HashRow.libelle_sexe = row4.libelle_sexe;
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbname_tDBInput_3 = "PROJET_ENT";
				...
				String dbquery_tDBInput_3 = "SELECT TAILLE_ENTREPRISE_DIM.id_taille_entreprise_pk,\n		TAILLE_ENTREPRISE_DIM.libelle_taille_entreprise\nFROM	TAILLE_ENT"
						+ "REPRISE_DIM";
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 1) {
							row3.id_taille_entreprise_pk = 0;
						} else {

							if (rs_tDBInput_3.getObject(1) != null) {
								row3.id_taille_entreprise_pk = rs_tDBInput_3
										.getInt(1);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							...
							if (tmpContent_tDBInput_3 != null) {
								if (talendToDBList_tDBInput_3
										.contains(rsmd_tDBInput_3
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row3.libelle_taille_entreprise = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_3);
								} else {
									row3.libelle_taille_entreprise = tmpContent_tDBInput_3;
								}
							} else {
								row3.libelle_taille_entreprise = null;
							}
						...
						row3_HashRow.id_taille_entreprise_pk = row3.id_taille_entreprise_pk;

						row3_HashRow.libelle_taille_entreprise = row3.libelle_taille_entreprise;
	...
	public static void main(String[] args) {
		final integrationT403 integrationT403Class = new integrationT403();

		int exitCode = integrationT403Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = integrationT403.class
					.getClassLoader().getResourceAsStream(
							"test_2/integrationt403_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = integrationT403.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : integrationT403");
		}
...
/************************************************************************************************
 * 131401 characters generated by Talend Open Studio for Data Integration on the
 * 28 mai 2019 01:54:06 CEST
 ************************************************************************************************/
