...
public class test2 implements TalendJob {
	...
	public static class testStruct implements
		...
		final static byte[] commonByteArrayLock_TEST_2_test2 = new byte[0];
		static byte[] commonByteArray_TEST_2_test2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_2_test2.length) {
					if (length < 1024
							&& commonByteArray_TEST_2_test2.length == 0) {
						commonByteArray_TEST_2_test2 = new byte[1024];
					} else {
						commonByteArray_TEST_2_test2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_2_test2, 0, length);
				strReturn = new String(commonByteArray_TEST_2_test2, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_2_test2) {
	...
	public void tFileInputExcel_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbname_tDBOutput_2 = "TEST";
				...
				Object source_tFileInputExcel_1 = "C:/Users/hakan/Downloads/Classeur1.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1]
									...
									row1.Column9 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Column9 = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1]
									...
									row1.Column10 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Column10 = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1]
									...
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1
											+ 1;
									curColName_tFileInputExcel_1 = "Column11";

									row1.Column11 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Column11 = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1]
									...
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1
											+ 1;
									curColName_tFileInputExcel_1 = "Column12";

									row1.Column12 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Column12 = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1]
									...
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1
											+ 1;
									curColName_tFileInputExcel_1 = "Column13";

									row1.Column13 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Column13 = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
							...
							if (row1 != null) {
								...
								if (test != null) {
									...
									if (execStat) {
										runStat.updateStatOnConnection("test"
												+ iterateId, 1, 1);
									}

									whetherReject_tDBOutput_2 = false;
									pstmt_tDBOutput_2.setInt(1, test.id);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = test2.class.getClassLoader()
					.getResourceAsStream(
							"test_2/test2_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 67119 characters generated by Talend Open Studio for Data Integration on the
 * 25 mai 2019 14:59:29 CEST
 ************************************************************************************************/
